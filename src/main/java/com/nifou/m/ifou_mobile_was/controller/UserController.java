...
import com.nifou.m.ifou_mobile_was.common.JWT.TokenController;
...
public class UserController {
    ...
    public TokenController.TokenResponse getUser(@RequestParam("userid") String userId,
        ...
        uInfo = userService.getUser(userId);
        ...
        String strUserUauth ="";
        String uauth_base64 ="";
        TokenController.TokenResponse token = tokenController.createToken(rtnmsg, "");
        ...
        if(rtnmsg.equals("0000")) {
            ...
            token = tokenController.createToken(rtnmsg, uauth_base64);
